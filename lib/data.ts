...
export const GAMES: Game[] = [
  ...
  },
  {
    ...
    long: "Tu nave triangular flota en vacío absoluto. Dispara y rota para dividir rocas en fragmentos cada vez más pequeños, y recoge el disparo triple antes de que se apague.",
    cat: "SHOOTER",
    cover: "cover-rocas",
    color: "yellow",
    best: 41200,
